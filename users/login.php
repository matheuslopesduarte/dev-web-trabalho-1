...
$url = $protocolo . $endereco;
    ...
    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
        ...
        if (mysqli_num_rows($results) == 1) {
            ...
            setcookie('loggedin', true, time() + (86400 * 30), "/", null, true, true);
            setcookie('UserId', $row['Userid'], time() + (86400 * 30), "/", null, true, true);
            setcookie('upaxmn', $row['upaxmn'], time() + (86400 * 30), "/", null, true, true);
            setcookie('upaymn', $row['upaymn'], time() + (86400 * 30), "/", null, true, true);
            setcookie('upazmn', $row['upazmn'], time() + (86400 * 30), "/", null, true, true);
            ...
            try {
                ...
                $mail->setFrom('zoho.email', 'Mock - Login detectado');
