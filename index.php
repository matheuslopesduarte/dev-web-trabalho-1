...
<body>
    ...
    <style>
        ...
        .carousel li {
            flex: 0 0 320px;
            /* Cada item tem largura fixa de 300px + 10px * 2 */
            padding: 0 10px;
            /* Adiciona o padding aos itens */
        }
    ...
    if ($result->num_rows > 0) {
        ...
        if ($result_card_indiv->num_rows > 0) {
            while ($row_card = $result_card_indiv->fetch_assoc()) {
                ...
                echo '
                    <section class="sec-card-indiv">
                        <div class="card-indiv" id="card" data-url="' . $url . '/' . 'posts/verPost.php?PageId=' . $row_card['Pageid'] . '">
                    <a class="alink-card-indiv">
                        <h2 class="h2-card-indiv">' . $row_card['title'] . '</h2>
                        <p class="p-card-indiv">' . $row_card['description'] . '</p>
                    </a>
                    <a class="a-img-card-indiv"><img class="img-card-indiv" src="data:image/jpeg;base64,' . base64_encode($row_card["cover_image"]) . '"/></a>
                    <div class="div-autor-card-indiv">
                        <a href="' . $url . '/users/verUsuario.php?UserId=' . $row_card_creator['Userid'] . '" class="a-autor-card-indiv">
                            <div>
                                <img style="border-radius:50%" class="autor-img-car-indiv"
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div>
                ...
                <h2 class="h2-topico-carrosel">' . $row['topic'] . '</h2>
                    ...
                    <a class="a-more-topico-carrosel" href="' . $url . '/' . 'posts/verTopico.php?TopicoName=' . $row['topic'] . '">
        ...
        <div class="div-item-carrousel">
            <li>
                <a href="' . $url . '/' . 'posts/verPost.php?PageId=' . $row['Pageid'] . '" class="a-item-carrosel">
                    ...
                    <img class="image-carrousel" src="data:image/jpeg;base64,' . base64_encode($row["cover_image"]) . '"/>
                </a>
            </li>
        </div>';
        }
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const divElements = document.querySelectorAll('.card-indiv');
        ...
        function setupCarousels() {
            ...
            carousels.forEach(function (carousel) {
                ...
                const listItem = carousel.querySelectorAll('li');
